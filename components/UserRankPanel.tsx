    ...
    <div className="bg-gray-900/50 backdrop-blur-sm border border-gray-700/50 rounded-lg p-6 shadow-lg shadow-black/20 text-white flex flex-col h-full">
      ...
      <div className="mt-4 space-y-2">
         <button 
          ...
          <button 
            onClick={onResetKey}
            className="w-full flex items-center justify-center gap-2 text-gray-400 p-3 rounded-lg bg-gray-800/50 hover:bg-gray-700/70 hover:text-white transition-colors"
          >
