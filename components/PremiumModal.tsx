...
import CriticalThinkingSyllabus from './CriticalThinkingSyllabus.tsx';
...
const PremiumModal: React.FC<PremiumModalProps> = ({ onClose }) => {
  ...
  return (
    <>
        ...
        >
          ...
          <div className="text-center my-6">
            <button
              ...
              className="text-blue-400 font-semibold hover:underline text-center"
            >
              Ver temario del Curso Maestro en Pensamiento Crítico
            </button>
          </div>
      ...
      {showSyllabus && <CriticalThinkingSyllabus onClose={() => setShowSyllabus(false)} />}
    </>
  );
};
